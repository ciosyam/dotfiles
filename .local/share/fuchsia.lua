...
M.base_30 = {
  ...
  vibrant_green   = "#ff009c",  -- analogye pink
  nord_blue       = "#00c4ff",  -- tetradic cyan
  blue            = "#d018d0",  -- darker fuchsia
...
M.base_16 = {
  ...
  base01 = "#2b2b2b",  -- chinese black
  base02 = "#4b4b4b",  -- eerie black
  ...
  base09 = "#0036ff",  -- tetradic cyan
  base0A = "#00c4ff",  -- tetradic red
